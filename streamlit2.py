...
# 데이터 로드
file_path = r'C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\streamtli1 11.14\교통사고+현황(구별)_20241114203251.csv'
...
# GeoJSON 파일 경로
geojson_path = r'C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\streamtli1 11.14\서울특별시 지역구.geojson'
